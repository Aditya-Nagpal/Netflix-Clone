            ...
            isHovered && (
                <div className="hover">
                    <div className="image-video-container">
                        ...
                        <ReactPlayer className="video" url="https://www.youtube.com/watch?v=HhesaQXLuRY" playing loop muted />
                    </div>
                    <div className="info-container flex column">
                        ...
                        <div className="genres flex">
                            <ul className="flex">{movieData.genres.map((genre) => <li key={genre}>{genre}</li> )}</ul>
                        </div>
                    </div>
                </div>
            )
